...
func tswift_grammarnlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		0, 0, 157, 158, 5, 41, 0, 0, 158, 2, 1, 0, 0, 0, 159, 160, 5, 40, 0, 0,
		160, 4, 1, 0, 0, 0, 161, 162, 5, 123, 0, 0, 162, 6, 1, 0, 0, 0, 163, 164,
		5, 125, 0, 0, 164, 8, 1, 0, 0, 0, 165, 166, 5, 91, 0, 0, 166, 10, 1, 0,
		0, 0, 167, 168, 5, 93, 0, 0, 168, 12, 1, 0, 0, 0, 169, 170, 5, 58, 0, 0,
		170, 14, 1, 0, 0, 0, 171, 172, 5, 59, 0, 0, 172, 16, 1, 0, 0, 0, 173, 174,
		5, 63, 0, 0, 174, 18, 1, 0, 0, 0, 175, 176, 5, 44, 0, 0, 176, 20, 1, 0,
...
const (
	...
	Tswift_GrammarNLexerCHARACTER     = 67
