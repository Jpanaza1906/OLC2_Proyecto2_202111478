...
package TswiftG // Tswift_Grammar
import (
	"fmt"
	"strconv"
	"sync"
...
func tswift_grammarParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 76, 100, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		0, 27, 28, 6, 1, -1, 0, 28, 34, 1, 0, 0, 0, 29, 30, 5, 33, 0, 0, 30, 34,
		6, 1, -1, 0, 31, 32, 5, 34, 0, 0, 32, 34, 6, 1, -1, 0, 33, 14, 1, 0, 0,
		0, 33, 19, 1, 0, 0, 0, 33, 24, 1, 0, 0, 0, 33, 29, 1, 0, 0, 0, 33, 31,
		1, 0, 0, 0, 34, 49, 1, 0, 0, 0, 35, 36, 10, 6, 0, 0, 36, 37, 5, 27, 0,
		0, 37, 38, 3, 4, 2, 0, 38, 39, 3, 2, 1, 7, 39, 40, 6, 1, -1, 0, 40, 48,
		1, 0, 0, 0, 41, 42, 10, 5, 0, 0, 42, 43, 5, 28, 0, 0, 43, 44, 3, 4, 2,
		...
		-1, 0, 53, 5, 1, 0, 0, 0, 54, 55, 6, 3, -1, 0, 55, 56, 5, 18, 0, 0, 56,
		57, 3, 6, 3, 6, 57, 58, 6, 3, -1, 0, 58, 69, 1, 0, 0, 0, 59, 60, 5, 2,
		0, 0, 60, 61, 3, 6, 3, 0, 61, 62, 5, 1, 0, 0, 62, 63, 6, 3, -1, 0, 63,
		69, 1, 0, 0, 0, 64, 65, 5, 69, 0, 0, 65, 69, 6, 3, -1, 0, 66, 67, 5, 73,
		...
		0, 83, 7, 1, 0, 0, 0, 84, 82, 1, 0, 0, 0, 85, 86, 5, 21, 0, 0, 86, 98,
		6, 4, -1, 0, 87, 88, 5, 22, 0, 0, 88, 98, 6, 4, -1, 0, 89, 90, 5, 25, 0,
		0, 90, 98, 6, 4, -1, 0, 91, 92, 5, 26, 0, 0, 92, 98, 6, 4, -1, 0, 93, 94,
		5, 23, 0, 0, 94, 98, 6, 4, -1, 0, 95, 96, 5, 24, 0, 0, 96, 98, 6, 4, -1,
...
const (
	...
	Tswift_GrammarParserPUNTO         = 10
	Tswift_GrammarParserGUIONBAJO     = 11
	Tswift_GrammarParserDIR           = 12
	Tswift_GrammarParserMASIGUAL      = 13
	Tswift_GrammarParserMENOSIGUAL    = 14
	Tswift_GrammarParserIGUAL         = 15
	Tswift_GrammarParserDIV           = 16
	Tswift_GrammarParserMOD           = 17
	Tswift_GrammarParserMENOS         = 18
	Tswift_GrammarParserMAS           = 19
	Tswift_GrammarParserPOR           = 20
	Tswift_GrammarParserIGUALIGUAL    = 21
	Tswift_GrammarParserDIFERENTE     = 22
	Tswift_GrammarParserMAYORIGUAL    = 23
	Tswift_GrammarParserMENORIGUAL    = 24
	Tswift_GrammarParserMAYOR         = 25
	Tswift_GrammarParserMENOR         = 26
	Tswift_GrammarParserAND           = 27
	Tswift_GrammarParserOR            = 28
	Tswift_GrammarParserNOT           = 29
	Tswift_GrammarParserPRINT         = 30
	Tswift_GrammarParserVAR           = 31
	Tswift_GrammarParserLET           = 32
	Tswift_GrammarParserTRUE          = 33
	Tswift_GrammarParserFALSE         = 34
	Tswift_GrammarParserIF            = 35
	Tswift_GrammarParserELSE          = 36
	Tswift_GrammarParserSWITCH        = 37
	Tswift_GrammarParserCASE          = 38
	Tswift_GrammarParserDEFAULT       = 39
	Tswift_GrammarParserWHILE         = 40
	Tswift_GrammarParserFOR           = 41
	Tswift_GrammarParserIN            = 42
	Tswift_GrammarParserRANGO         = 43
	Tswift_GrammarParserGUARD         = 44
	Tswift_GrammarParserCONTINUE      = 45
	Tswift_GrammarParserRETURN        = 46
	Tswift_GrammarParserBREAK         = 47
	Tswift_GrammarParserNIL           = 48
	Tswift_GrammarParserAPPEND        = 49
	Tswift_GrammarParserREMOVELAST    = 50
	Tswift_GrammarParserREMOVE        = 51
	Tswift_GrammarParserAT            = 52
	Tswift_GrammarParserISEMPTY       = 53
	Tswift_GrammarParserCOUNT         = 54
	Tswift_GrammarParserFUNC          = 55
	Tswift_GrammarParserREPEATING     = 56
	Tswift_GrammarParserSTRUCT        = 57
	Tswift_GrammarParserMUTATING      = 58
	Tswift_GrammarParserINOUT         = 59
	Tswift_GrammarParserATOI          = 60
	Tswift_GrammarParserIOTA          = 61
	Tswift_GrammarParserSELF          = 62
