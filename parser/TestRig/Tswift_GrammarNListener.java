...
public interface Tswift_GrammarNListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code S_e}
	 * labeled alternative in {@link Tswift_GrammarNParser#sentencia}.
	 * @param ctx the parse tree
	 */
	void enterS_e(Tswift_GrammarNParser.S_eContext ctx);
	/**
	 * Exit a parse tree produced by the {@code S_e}
	 * labeled alternative in {@link Tswift_GrammarNParser#sentencia}.
	 * @param ctx the parse tree
	 */
	void exitS_e(Tswift_GrammarNParser.S_eContext ctx);
	/**
